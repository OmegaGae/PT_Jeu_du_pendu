...
class Players:
    ...
    def get_player_letter(self) -> str:
        ...
        while True:
            self.player_letter = input(f"Please enter an alphabetic letter: ").lower()
    ...
    def displayed_data_player(self, nameplayer, playerscore) -> None:
        """Return player name, score, and last letters"""
